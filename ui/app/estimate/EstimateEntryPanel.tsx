...
const secondaryActions: EntryAction[] = [
  { title: '캘린더 / 현장조사 Sync', headline: '현장 방문 일정 / 내부 알림 / 충돌 / Sync 불일치 검토', note: 'RC-0.4.4', view: 'calendarSiteSurveySync', tone: 'confirm' },
  ...
  { title: 'LightBIM 추적 보기', headline: '도면 수량부터 현장 사용까지 연결 확인', note: '추적 감사', view: 'lightbimTraceability', tone: 'warning' },
  { title: 'LightBIM 공간 맵', headline: '공간을 클릭해 연결 수량과 위험 확인', note: '도면 보기', view: 'lightbimSpaceMap', tone: 'warning' },
  { title: '고객용 공간 제안 맵', headline: '공간 구성과 공사 범위를 고객용으로 안내', note: '제안 자료', view: 'lightbimCustomerMap', tone: 'warning' },
